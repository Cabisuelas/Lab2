...
<head>
  ...
  <link rel="icon" type="image/png" href="./assets/images/samurai_sword.png" />
...
<body>
  ...
  <main>
    ...
    <section class="favorite-pet">
      ...
      <div>
        <img src="./assets/images/cat_girl.jpg" alt="cat" width="400" />
      </div>
    </section>
    <section class="challenges">
      <div class="heading">
        <img src="./assets/images/cloud.svg" alt="Clouds" />
        <h2>Challenges</h2>
        <img src="./assets/images/cloud.svg" alt="Clouds" class="second-cloud" />
      </div>
      <div class="description">
        <div class="gif">
    ...
    <div class="waifu-container">
      <div class="waifu-gallery">
        ...
        <div class="container">
          <div class="image">
            <img src="./assets/images/albedo.png" alt="Albedo" />
          </div>
          <div class="image">
            <img src="./assets/images/delta.png" alt="Delta" />
          </div>
          <div class="image">
            <img src="./assets/images/emi.png" alt="Emi" />
          </div>
          <div class="image">
            <img src="./assets/images/mei.png" alt="Mei" />
          </div>
          <div class="image">
            <img src="./assets/images/raphtalia.png" alt="Raphtali" />
          </div>
          <div class="image">
            <img src="./assets/images/shalltear.png" alt="Shalltear" />
          </div>
          <div class="image">
            <img src="./assets/images/sheya.png" alt="Sheya" />
          </div>
          <div class="image">
            <img src="./assets/images/shion.png" alt="Shion" />
          </div>
          <div class="image">
            <img src="./assets/images/tio.png" alt="Tio" />
          </div>
          <div class="image">
            <img src="./assets/images/rem.png" alt="Rem" />
          </div>
        </div>
      </div>
    </div>
